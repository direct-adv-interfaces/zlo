...
Zlo.prototype.killMD5 = function (options) {
    ...
    (!options.svn && options.local ?
        //удаляем только локальный кэш
        this._removeCacheFiles(this._cacheFileNames) :
        //пытаемся очистить svn-кэш
        this._checkCashesInSVN()
            ...
            .then(function() {
                ...
                return options.local ? this._removeCacheFiles(this._cacheFileNames) : true;
            }.bind(this))
    ).then(function() {
...
Zlo.prototype.killAll = function (options) {
    ...
    (!options.svn && options.local ?
        ...
        this._doCmd(currentDir, 'svn checkout --depth immediates ' + svn.url + ' .')
            ...
            .then(function() {
                return  (!options.local) ? this._removeAllCacheFiles() : true;
            }.bind(this))
    )
        .then(function() {
