...
function Zlo(config, packageData, options) {
    ...
    TIMEOUT = options.loadingTimeout || TIMEOUT;
...
Zlo.prototype.killMD5 = function (options) {
    ...
    this._checkCashesInSVN()
        ...
        .then(function() {
            ...
            return !options.svnOnly ? this._removeCacheFiles([this._cacheFileName]) : true;
        }.bind(this))
 ...
 * @param {String} file файл, который нужно забрать из репозитория
 * @retutn {Promise}
 * @private
 */
