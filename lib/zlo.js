 ...
 * @param options.disableSvn {Boolean} not use svn cache
 * @constructor
 */
function Zlo(config, packageData, options) {
    ...
    var cwd = process.cwd(),
        ...
        cacheFileName = STORAGE_FOLDER + (options.dev ? '.dev.' : '.') + os.platform() + '.' + mdHash + '.tar',
    ...
    if (!config || !config.svnCachePath && !options.disableSvn) {
...
Zlo.prototype._onLoadingFinished = function(source) {
    ...
    if (source == 'local' && !this.options.disableSvn) {
        ...
        postProcessFunction = function() {
            return this._archiveDependencies()
                .then(function() {
                    return !this.options.disableSvn && this._tryPutToSvn();
                }.bind(this))
        }.bind(this);
    }
...
Zlo.prototype._removeOldDependencies = function() {
...
Zlo.prototype.loadDependencies = function(options) {
    ...
    var loadFromExternalStoragePipe = function() {
    ...
    return this._loadFromLocalCache()
        ...
        .catch(function(err) {
            ...
            return this.options.disableSvn ?
                loadFromExternalStoragePipe() :
                this._loadFromSVNCache()
                    .then(function() {
                    ...
                    .catch(function(err) {
                        ...
                        return loadFromExternalStoragePipe();
                    }.bind(this))
        }.bind(this));
