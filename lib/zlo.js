...
function Zlo(config, packageData, options) {
    ...
    if (!config || !config.svnCachePath) {
        this._endFail('Empty svn storage path', null, false);
...
Zlo.prototype.killMD5 = function(options) {
    ...
    options.svn && promisesArray.push(this._removeSvnCache({ removeOnlyCurrent: true }));
...
Zlo.prototype.killAllExceptCurrent = function(options) {
    ...
    options.local && promisesArray.push(this._removeAllCacheFiles({ skipCurrent: true }));
    options.svn && promisesArray.push(this._removeSvnCache({ skipCurrent: true }));
...
Zlo.prototype._onLoadingFinished = function(source) {
    ...
    postProcessFunction()
        .then(function() {
            this._endSuccess('Dependencies were successfully loaded', true);
        }.bind(this))
        .catch(function(err) {
            ...
            return this._loadFromSVNCache()
                ...
                .catch(function(err) {
                    ...
                    return this._loadFromExternalStorage()
                        ...
                        .catch(function() {
                            this._endFail('Dependencies loading error');
                        }.bind(this));
                }.bind(this))
        }.bind(this));
